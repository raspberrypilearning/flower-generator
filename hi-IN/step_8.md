...
**Choose a backdrop** पर क्लिक करें, और फिर **Paint** पर क्लिक करें। बिटमैप मोड (Bitmap mode) में भरण उपकरण (Fill tool) का उपयोग करके एक नारंगी पृष्ठभूमि (orange backdrop) बनाएं।
