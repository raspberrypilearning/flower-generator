...
```blocks3
define 花を描く (色)
set [color v] effect to (色 :: custom-arg)
repeat (6)
  stamp
  turn cw (60) degrees
end
...
```blocks3
define 花を描く (色) (大きさ :: custom-arg)
set [color v] effect to (色 :: custom-arg)
set size to (大きさ :: custom-arg) %
repeat (6) 
  stamp
  turn cw (60) degrees
end
