...
```blocks3
define dibuja flor (color)
set [color v] effect to (color :: custom-arg)
repeat (6)
  stamp
  turn cw (60) degrees
end
...
erase all
go to x: (75) y: (75)
dibuja flor (180) :: custom
go to x: (-75) y: (-75)
dibuja flor (150) :: custom
```
...
```blocks3
define dibuja flor (color) (tamaño :: custom-arg)
set [color v] effect to (color :: custom-arg)
set size to (tamaño :: custom-arg) %
repeat (6) 
  stamp
  turn cw (60) degrees
end
